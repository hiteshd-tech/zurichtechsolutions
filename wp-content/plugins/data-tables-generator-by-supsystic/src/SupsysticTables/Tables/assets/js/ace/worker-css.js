    ...
    (function () {
      ...
      (r.implement(this, i),
        ...
        (this.$clipPositionToDocument = function (e, t) {
          var n = {};
          return (
            e >= this.document.getLength() ? ((n.row = Math.max(0, this.document.getLength() - 1)), (n.column = this.document.getLine(n.row).length)) : e < 0 ? ((n.row = 0), (n.column = 0)) : ((n.row = e), (n.column = Math.min(this.document.getLine(n.row).length, Math.max(0, t)))),
            t < 0 && (n.column = 0),
            n
          );
        }));
        ...
        (i.prototype = {
          ...
          get: function (e) {
            ...
            return (
              ...
              u.type > -1 &&
                !t[u.type].hide &&
                ((u.channel = t[u.type].channel), (this._token = u), this._lt.push(u), this._ltIndexCache.push(this._lt.length - this._ltIndex + i), this._lt.length > 5 && this._lt.shift(), this._ltIndexCache.length > 5 && this._ltIndexCache.shift(), (this._ltIndex = this._lt.length)),
              (a = t[u.type]),
                ...
                : /^([+\-]?[\d\.]+)$/i.test(text)
                  ...
                  : /^#([a-f0-9]{3,6})/i.test(text)
                    ? ((this.type = 'color'),
                      (temp = RegExp.$1),
                      temp.length == 3
                        ? ((this.red = parseInt(temp.charAt(0) + temp.charAt(0), 16)), (this.green = parseInt(temp.charAt(1) + temp.charAt(1), 16)), (this.blue = parseInt(temp.charAt(2) + temp.charAt(2), 16)))
                        : ((this.red = parseInt(temp.substring(0, 2), 16)), (this.green = parseInt(temp.substring(2, 4), 16)), (this.blue = parseInt(temp.substring(4, 6), 16))))
                    : /^rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i.test(text)
                      ? ((this.type = 'color'), (this.red = +RegExp.$1), (this.green = +RegExp.$2), (this.blue = +RegExp.$3))
                      : /^rgb\(\s*(\d+)%\s*,\s*(\d+)%\s*,\s*(\d+)%\s*\)/i.test(text)
                        ? ((this.type = 'color'), (this.red = (+RegExp.$1 * 255) / 100), (this.green = (+RegExp.$2 * 255) / 100), (this.blue = (+RegExp.$3 * 255) / 100))
                        : /^rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d\.]+)\s*\)/i.test(text)
                          ? ((this.type = 'color'), (this.red = +RegExp.$1), (this.green = +RegExp.$2), (this.blue = +RegExp.$3), (this.alpha = +RegExp.$4))
                          : /^rgba\(\s*(\d+)%\s*,\s*(\d+)%\s*,\s*(\d+)%\s*,\s*([\d\.]+)\s*\)/i.test(text)
                            ? ((this.type = 'color'), (this.red = (+RegExp.$1 * 255) / 100), (this.green = (+RegExp.$2 * 255) / 100), (this.blue = (+RegExp.$3 * 255) / 100), (this.alpha = +RegExp.$4))
                            : /^hsl\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*\)/i.test(text)
                              ? ((this.type = 'color'), (this.hue = +RegExp.$1), (this.saturation = +RegExp.$2 / 100), (this.lightness = +RegExp.$3 / 100))
                              : /^hsla\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*,\s*([\d\.]+)\s*\)/i.test(text)
                                ? ((this.type = 'color'), (this.hue = +RegExp.$1), (this.saturation = +RegExp.$2 / 100), (this.lightness = +RegExp.$3 / 100), (this.alpha = +RegExp.$4))
                                : /^url\(["']?([^\)"']+)["']?\)/i.test(text)
                                  ...
                                  : /^([^\(]+)\(/i.test(text)
                                    ...
                                    : /^["'][^"']*["']/.test(text)
                                      ...
                                      : Colors[text.toLowerCase()]
                                        ? ((this.type = 'color'), (temp = Colors[text.toLowerCase()].substring(1)), (this.red = parseInt(temp.substring(0, 2), 16)), (this.green = parseInt(temp.substring(2, 4), 16)), (this.blue = parseInt(temp.substring(4, 6), 16)))
                                        : /^[\,\/]$/.test(text)
                                          ? ((this.type = 'operator'), (this.value = text))
                                          : /^[a-z\-_\u0080-\uFFFF][a-z0-9\-_\u0080-\uFFFF]*$/i.test(text) && ((this.type = 'identifier'), (this.value = text));
        }
              ...
              n = {
                ...
                _charset: function (e) {
                  ...
                  t.match(Tokens.CHARSET_SYM) &&
                    ((i = t.token().startLine), (s = t.token().startCol), this._readWhitespace(), t.mustMatch(Tokens.STRING), (r = t.token()), (n = r.value), this._readWhitespace(), t.mustMatch(Tokens.SEMICOLON), e !== !1 && this.fire({ type: 'charset', charset: n, line: i, col: s }));
                },
                _import: function (e) {
                  var t = this._tokenStream,
                    n,
                ...
                _property: function () {
                  var e = this._tokenStream,
                    ...
                    o;
                  return (
                    e.peek() == Tokens.STAR && this.options.starHack && (e.get(), (i = e.token()), (n = i.value), (s = i.startLine), (o = i.startCol)),
                ...
                _attrib: function () {
                  ...
                  return e.match(Tokens.LBRACKET)
                    ? ((r = e.token()),
                      ...
                      (t += e.token().value),
                      (t += this._readWhitespace()),
                      e.match([Tokens.PREFIXMATCH, Tokens.SUFFIXMATCH, Tokens.SUBSTRINGMATCH, Tokens.EQUALS, Tokens.INCLUDES, Tokens.DASHMATCH]) &&
                        ((t += e.token().value), (t += this._readWhitespace()), e.mustMatch([Tokens.IDENT, Tokens.STRING]), (t += e.token().value), (t += this._readWhitespace())),
                ...
                _pseudo: function () {
                  ...
                  return (
                    e.match(Tokens.COLON) &&
                      ...
                      e.match(Tokens.IDENT) ? ((t = e.token().value), (r = e.token().startLine), (i = e.token().startCol - n.length)) : e.peek() == Tokens.FUNCTION && ((r = e.LT(1).startLine), (i = e.LT(1).startCol - n.length), (t = this._functional_pseudo())),
                  ...
                  return (
                    ...
                    t.peek() == Tokens.IE_FUNCTION && this.options.ieFilters
                      ...
                      : e && t.match([Tokens.LPAREN, Tokens.LBRACE, Tokens.LBRACKET])
                        ? ((s = t.token()), (i = s.endChar), (r = s.value + this._expr(e).text), n === null && ((o = t.token().startLine), (u = t.token().startCol)), t.mustMatch(Tokens.type(i)), (r += i), this._readWhitespace())
                        : t.match([Tokens.NUMBER, Tokens.PERCENTAGE, Tokens.LENGTH, Tokens.ANGLE, Tokens.TIME, Tokens.FREQ, Tokens.STRING, Tokens.IDENT, Tokens.URI, Tokens.UNICODE_RANGE])
                          ? ((r = t.token().value), n === null && ((o = t.token().startLine), (u = t.token().startCol)), this._readWhitespace())
                          : ((s = this._hexcolor()),
                            s === null ? (n === null && ((o = t.LT(1).startLine), (u = t.LT(1).startCol)), r === null && (t.LA(3) == Tokens.EQUALS && this.options.ieFilters ? (r = this._ie_function()) : (r = this._function()))) : ((r = s.value), n === null && ((o = s.startLine), (u = s.startCol)))),
        ...
        TokenStream.prototype = mix(new TokenStreamBase(), {
          ...
          identOrFunctionToken: function (e, t, n) {
            var r = this._reader,
              ...
              s = Tokens.IDENT;
            return (
              r.peek() == '(' ? ((i += r.read()), i.toLowerCase() == 'url(' ? ((s = Tokens.URI), (i = this.readURI(i)), i.toLowerCase() == 'url(' && (s = Tokens.FUNCTION)) : (s = Tokens.FUNCTION)) : r.peek() == ':' && i.toLowerCase() == 'progid' && ((i += r.readTo('(')), (s = Tokens.IE_FUNCTION)),
          ...
          unicodeRangeToken: function (e, t, n) {
            ...
            return (
              r.peek() == '+' &&
                (r.mark(), (i += r.read()), (i += this.readUnicodeRangePart(!0)), i.length == 2 ? r.reset() : ((o = Tokens.UNICODE_RANGE), i.indexOf('?') == -1 && r.peek() == '-' && (r.mark(), (s = r.read()), (s += this.readUnicodeRangePart(!1)), s.length == 1 ? r.reset() : (i += s)))),
              this.createToken(o, i, t, n)
            );
          },
          ...
          multiProperty: function (e, t, n, r) {
            ...
            if (!i)
              throw t.hasNext() && !t.isFirst()
                ...
                : ((a = t.previous()), n && a == ',' ? new ValidationError("Expected end of value but found '" + a + "'.", a.line, a.col) : new ValidationError('Expected (' + e + ") but found '" + s + "'.", s.line, s.col));
                ...
                o < 3
                  ...
                  : ValidationTypes.isAny(e, i)
                    ? ValidationTypes.isAny(e, s)
                      ...
                      : ValidationTypes.isAny(e, r) && (ValidationTypes.isAny(e, s) ? ((n = !0), ValidationTypes.isAny(e, r)) : ValidationTypes.isAny(e, 'center') && (n = !0))
                    : ValidationTypes.isAny(e, s)
                      ? ValidationTypes.isAny(e, i)
                        ? ((n = !0), ValidationTypes.isAny(e, r))
                        : ValidationTypes.isAny(e, r) && (ValidationTypes.isAny(e, i) ? ((n = !0), ValidationTypes.isAny(e, r)) : ValidationTypes.isAny(e, 'center') && (n = !0))
                      : ValidationTypes.isAny(e, 'center') && ValidationTypes.isAny(e, i + ' | ' + s) && ((n = !0), ValidationTypes.isAny(e, r)),
                n
              );
            },
            '<bg-size>': function (e) {
        ...
        init: function (e, t) {
          ...
          (e.addListener('startrule', u),
            ...
            e.addListener('property', function (e) {
              ...
              i[t] || r[t]
                ? !/^0\S*$/.test(e.value) && (t !== 'border' || e.value.toString() !== 'none') && (s[t] = { line: e.property.line, col: e.property.col, value: e.value })
          ...
          e.addListener('property', function (e) {
            ...
            if (i.match(/background/i))
              for (o = 0, u = s.parts.length; o < u; o++)
                s.parts[o].type === 'uri' &&
                  (typeof r[s.parts[o].uri] == 'undefined' ? (r[s.parts[o].uri] = e) : t.report("Background image '" + s.parts[o].uri + "' was used multiple times, first declared at line " + r[s.parts[o].uri].line + ', col ' + r[s.parts[o].uri].col + '.', e.line, e.col, n));
          });
        },
      }),
      CSSLint.addRule({
                ...
                while (a < l)
                  (u[a].type === 'color' &&
                    ('alpha' in u[a] || 'hue' in u[a]
                      ? (/([^\)]+)\(/.test(u[a]) && (f = RegExp.$1.toUpperCase()), (!r || r.property.text.toLowerCase() !== o || r.colorType !== 'compat') && t.report('Fallback ' + o + ' (hex or RGB) should precede ' + f + ' ' + o + '.', e.line, e.col, n))
                      : (e.colorType = 'compat')),
                    a++);
              r = e;
            }));
          ...
          function u() {
            ...
            for (i = 0, o = f.length; i < o; i++)
              ((u = f[i].needed),
                (a = f[i].actual),
                r[u]
                  ? r[u][0].pos < r[a][0].pos && t.report("Standard property '" + u + "' should come after vendor-prefixed property '" + a + "'.", r[a][0].name.line, r[a][0].name.col, n)
                  : t.report("Missing standard property '" + u + "' to go along with '" + a + "'.", r[a][0].name.line, r[a][0].name.col, n));
          }
          var n = this,
            r,
            i,
