((function () {
      ...
      p = function () {
        (this.add('braces', 'insertion', function (e, t, n, r, i) {
          ...
          if (i == '{') {
            ...
            if (p.isSaneInsertion(n, r)) return /[\]\}\)]/.test(u[s.column]) || n.inMultiSelectMode ? (p.recordAutoInsert(n, r, '}'), { text: '{}', selection: [1, 1] }) : (p.recordMaybeInsert(n, r, '{'), { text: '{', selection: [1, 1] });
          } else if (i == '}') {
            c(n);
            var d = u.substring(s.column, s.column + 1);
            if (d == '}') {
              var v = r.$findOpeningBracket('}', { column: s.column + 1, row: s.row });
              if (v !== null && p.isAutoInsertedClosing(s, u, i)) return (p.popAutoInsertedClosing(), { text: '', selection: [1, 1] });
            }
          } else {
            if (i == '\n' || i == '\r\n') {
              c(n);
          ...
          this.add('parens', 'insertion', function (e, t, n, r, i) {
            if (i == '(') {
              ...
              if (f == ')') {
                ...
                if (l !== null && p.isAutoInsertedClosing(u, a, i)) return (p.popAutoInsertedClosing(), { text: '', selection: [1, 1] });
              }
            }
          }),
  ...
  ace.define(
    'ace/edit_session',
    ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/config', 'ace/lib/event_emitter', 'ace/selection', 'ace/mode/text', 'ace/range', 'ace/document', 'ace/background_tokenizer', 'ace/search_highlight', 'ace/edit_session/folding', 'ace/edit_session/bracket_match'],
    function (e, t, n) {
      'use strict';
      var r = e('./lib/oop'),
        i = e('./lib/lang'),
      ...
      ((function () {
        (r.implement(this, d),
          ...
          (this.find = function (e, t, n) {
            ...
            (t.needle == null && ((e = this.session.getTextRange(i) || this.$search.$options.needle), e || ((i = this.session.getWordRange(i.start.row, i.start.column)), (e = this.session.getTextRange(i))), this.$search.set({ needle: e })),
              this.$search.set(t),
  ...
  ace.define(
    ...
    ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/dom', 'ace/config', 'ace/lib/useragent', 'ace/layer/gutter', 'ace/layer/marker', 'ace/layer/text', 'ace/layer/cursor', 'ace/scrollbar', 'ace/scrollbar', 'ace/renderloop', 'ace/layer/font_metrics', 'ace/lib/event_emitter'],
    function (e, t, n) {
      'use strict';
      var r = e('./lib/oop'),
        i = e('./lib/dom'),
        ...
        ((this.CHANGE_CURSOR = 1),
          ...
          (this.scrollCursorIntoView = function (e, t, n) {
            ...
            a + o > s
              ...
              : a + this.$size.scrollerHeight - u < s + this.lineHeight && (t && a + this.$size.scrollerHeight - u < s - this.lineHeight && (s += t * this.$size.scrollerHeight), this.session.setScrollTop(s + this.lineHeight - this.$size.scrollerHeight));
  ...
  ace.define(
    'ace/multi_select',
    ['require', 'exports', 'module', 'ace/range_list', 'ace/range', 'ace/selection', 'ace/mouse/multi_select_handler', 'ace/lib/event', 'ace/lib/lang', 'ace/commands/multi_select_commands', 'ace/search', 'ace/edit_session', 'ace/editor', 'ace/config'],
    function (e, t, n) {
      function h(e, t, n) {
