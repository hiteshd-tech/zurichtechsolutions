...
class SupsysticTables_Tables_Controller extends SupsysticTables_Core_BaseController
{
  ...
  public function createAction(RscDtgs_Http_Request $request)
  {
    ...
    return $this->ajaxSuccess(['url' => $this->generateUrl('tables', 'view', ['id' => $tableId, 'nonce' => wp_create_nonce('dtgs_nonce')])]);
  }
  ...
  public function viewAction(RscDtgs_Http_Request $request)
  {
    ...
    return $this->response('@tables/view.twig', [
      ...
      'contact_form' => [
        ...
        'pages_list' => $contactFormIsInstalled ? $this->getPagesListForSelect() : [],
      ],
    ]);
  }
  ...
  public function renderAction(RscDtgs_Http_Request $request)
  {
    ...
    return $this->ajaxSuccess(['table' => $tables->render((int) $id, $settings)]);
  }
  ...
  public function getMetaAction(RscDtgs_Http_Request $request)
  {
    ...
    return $this->ajaxSuccess(['meta' => $tables->getMeta($id)]);
  }
