...
class SupsysticTables_Promo_Model_Promo extends SupsysticTables_Core_BaseModel
{
  ...
  {
    if (!$this->_bigCli) {
      $path = $this->environment->getConfig()->get('plugin_source') . '/' . $this->environment->getConfig()->get('plugin_prefix') . '/' . 'Promo/Model/classes/lib/Mixpanel.php';
  ...
  private function _bigStatAdd($key, $properties = [])
  {
