...
class SupsysticTables_Promo_Module extends SupsysticTables_Core_BaseModule
{
  ...
  public function enqueueTutorialAssets()
  {
    if (current_user_can('manage_options')) {
      ...
      wp_enqueue_script('supsystic-tables-step-tutorial', $modulePath . '/assets/js/tutorial.js', ['wp-pointer']);
    ...
    return [
      ...
      [
        ...
        'content' => sprintf(
          '<p>%s</p>',
          $this->translate(
            'Main Settings of your first table. Here you can see main settings which are conected with languages, table elements, styling and other different editors settings. Generally it’s a tab where you can edit the visual part of the whole table, switch on/off the responsive mode, set pagination etc.',
          ),
        ),
      ...
      [
        ...
        'content' => sprintf(
          '<p>%s</p>',
          $this->translate(
            'The most important part of settings - Editor. Here you can fill all the cells of your table, add some colors, play with fonts and sizes. This insert also allows you to change the alignment of your font, add formats (percents, currency), images and links to make your table more visual attraction.',
          ),
        ),
