...
class Twig_SupTwgDtgs_Parser implements Twig_SupTwgDtgs_ParserInterface
{
      ...
      switch ($this->getCurrentToken()->getType()) {
        ...
        case Twig_SupTwgDtgs_Token::BLOCK_START_TYPE:
          ...
          if (null !== $test && call_user_func($test, $token)) {
            ...
            return new Twig_SupTwgDtgs_Node($rv, [], $lineno);
          }
  ...
  {
    $this->blocks[$name] = new Twig_SupTwgDtgs_Node_Body([$value], [], $value->getTemplateLine());
  }
  ...
  protected function filterBodyNodes(Twig_SupTwgDtgs_NodeInterface $node)
  {
    ...
    if (($node instanceof Twig_SupTwgDtgs_Node_Text && !ctype_space($node->getAttribute('data'))) || (!$node instanceof Twig_SupTwgDtgs_Node_Text && !$node instanceof Twig_SupTwgDtgs_Node_BlockReference && $node instanceof Twig_SupTwgDtgs_NodeOutputInterface)) {
