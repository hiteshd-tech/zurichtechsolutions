...
class Twig_SupTwgDtgs_TokenParser_Block extends Twig_SupTwgDtgs_TokenParser
{
  public function parse(Twig_SupTwgDtgs_Token $token)
  {
    ...
    $this->parser->setBlock($name, $block = new Twig_SupTwgDtgs_Node_Block($name, new Twig_SupTwgDtgs_Node([]), $lineno));
    ...
    if ($stream->nextIf(Twig_SupTwgDtgs_Token::BLOCK_END_TYPE)) {
      ...
      $body = new Twig_SupTwgDtgs_Node([new Twig_SupTwgDtgs_Node_Print($this->parser->getExpressionParser()->parseExpression(), $lineno)]);
    }
