...
class Twig_SupTwgDtgs_Node_Module extends Twig_SupTwgDtgs_Node
{
  ...
  protected function compileTemplate(Twig_SupTwgDtgs_Compiler $compiler)
  {
    ...
    if (count($this->getNode('blocks')) || count($this->getNode('traits')) || !$this->hasNode('parent') || $this->getNode('parent') instanceof Twig_SupTwgDtgs_Node_Expression_Constant || count($this->getNode('constructor_start')) || count($this->getNode('constructor_end'))) {
  ...
  {
    $compiler->write("public function __construct(Twig_SupTwgDtgs_Environment \$env)\n", "{\n")->indent()->subcompile($this->getNode('constructor_start'))->write("parent::__construct(\$env);\n\n");
  ...
  protected function compileIsTraitable(Twig_SupTwgDtgs_Compiler $compiler)
  {
    ...
    if ($traitable) {
      ...
      if (!count($nodes)) {
        $nodes = new Twig_SupTwgDtgs_Node([$nodes]);
      }
