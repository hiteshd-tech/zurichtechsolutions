...
class Twig_SupTwgDtgs_NodeVisitor_Escaper extends Twig_SupTwgDtgs_BaseNodeVisitor
{
  ...
  protected function isSafeFor($type, Twig_SupTwgDtgs_NodeInterface $expression, $env)
  {
    ...
    if (null === $safe) {
      if (null === $this->traverser) {
        $this->traverser = new Twig_SupTwgDtgs_NodeTraverser($env, [$this->safeAnalysis]);
      }
  ...
  protected function getEscaperFilter($type, Twig_SupTwgDtgs_NodeInterface $node)
  {
    ...
    $args = new Twig_SupTwgDtgs_Node([new Twig_SupTwgDtgs_Node_Expression_Constant((string) $type, $line), new Twig_SupTwgDtgs_Node_Expression_Constant(null, $line), new Twig_SupTwgDtgs_Node_Expression_Constant(true, $line)]);
