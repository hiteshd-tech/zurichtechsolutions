...
class Twig_SupTwgDtgs_Environment
{
  ...
  public function createTemplate($template)
  {
    ...
    $loader = new Twig_SupTwgDtgs_Loader_Chain([new Twig_SupTwgDtgs_Loader_Array([$name => $template]), ($current = $this->getLoader())]);
  ...
  protected function initExtensions()
  {
    ...
    $this->parsers = new Twig_SupTwgDtgs_TokenParserBroker([], [], false);
    $this->filters = [];
    $this->functions = [];
    $this->tests = [];
    $this->visitors = [];
  ...
  {
    $hashParts = array_merge(array_keys($this->extensions), [(int) function_exists('Twig_SupTwgDtgs_template_get_attributes'), PHP_MAJOR_VERSION, PHP_MINOR_VERSION, self::VERSION, (int) $this->debug, $this->baseTemplateClass, (int) $this->strictVariables]);
