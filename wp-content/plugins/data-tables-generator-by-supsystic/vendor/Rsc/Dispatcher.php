...
class RscDtgs_Dispatcher
{
  ...
  public function on($action, $function, $priority = 10, $args = 1)
  {
    if (!is_callable($function)) {
      throw new InvalidArgumentException(sprintf('Argument 2 passed to RscDtgs_Dispatcher::on() must be a callable, %s given.', gettype($function)));
    }
  ...
  {
    if (!is_callable($function)) {
      throw new InvalidArgumentException(sprintf('Argument 2 passed to RscDtgs_Dispatcher::filter() must be a callable, %s given.', gettype($function)));
    }
