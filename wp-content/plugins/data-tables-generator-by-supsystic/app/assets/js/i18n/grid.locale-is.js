(function ($) {
  ...
  $.extend($.jgrid, {
    ...
    formatter: {
      ...
      date: {
        dayNames: ['Sun', 'Mán', 'Þri', 'Mið', 'Fim', 'Fös', 'Lau', 'Sunnudagur', 'Mánudagur', 'Þriðjudagur', 'Miðvikudagur', 'Fimmtudagur', 'Föstudagur', 'Laugardagur'],
        monthNames: ['Jan', 'Feb', 'Mar', 'Apr', 'Maí', 'Jún', 'Júl', 'Ágú', 'Sep', 'Oct', 'Nóv', 'Des', 'Janúar', 'Febrúar', 'Mars', 'Apríl', 'Maí', 'Júný', 'Júlý', 'Ágúst', 'September', 'Október', 'Nóvember', 'Desember'],
        AmPm: ['am', 'pm', 'AM', 'PM'],
        S: function (j) {
