(function ($) {
  ...
  $.extend($.jgrid, {
    ...
    formatter: {
      ...
      date: {
        dayNames: ['Dg', 'Dl', 'Dt', 'Dc', 'Dj', 'Dv', 'Ds', 'Diumenge', 'Dilluns', 'Dimarts', 'Dimecres', 'Dijous', 'Divendres', 'Dissabte'],
        monthNames: ['Gen', 'Febr', 'Març', 'Abr', 'Maig', 'Juny', 'Jul', 'Ag', 'Set', 'Oct', 'Nov', 'Des', 'Gener', 'Febrer', 'Març', 'Abril', 'Maig', 'Juny', 'Juliol', 'Agost', 'Setembre', 'Octubre', 'Novembre', 'Desembre'],
        AmPm: ['am', 'pm', 'AM', 'PM'],
        S: function (j) {
