(function ($) {
  ...
  $.extend($.jgrid, {
    ...
    search: {
      ...
      odata: [
        { oper: 'eq', text: 'baraz' },
        { oper: 'ne', text: 'jo baraz' },
        { oper: 'lt', text: 'me e vogel' },
        { oper: 'le', text: 'me e vogel ose baraz' },
        { oper: 'gt', text: 'me e madhe' },
        { oper: 'ge', text: 'me e madhe ose baraz' },
        { oper: 'bw', text: 'fillon me' },
        { oper: 'bn', text: 'nuk fillon me' },
        { oper: 'in', text: 'brenda' },
        { oper: 'ni', text: 'jo brenda' },
        { oper: 'ew', text: 'mbaron me' },
        { oper: 'en', text: 'nuk mbaron me' },
        { oper: 'cn', text: 'permban' },
        { oper: 'nc', text: 'nuk permban' },
        { oper: 'nu', text: 'eshte bosh' },
        { oper: 'nn', text: 'nuk eshte bosh' },
        { oper: 'bt', text: 'between' },
      ],
      groupOps: [
        { op: 'AND', text: 'te gjithe' },
        { op: 'OR', text: 'cfaredo' },
      ],
    ...
    formatter: {
      ...
      date: {
        dayNames: ['Dje', 'Hën', 'Mar', 'Mër', 'Enj', 'Pre', 'Sht', 'Djelë', 'Hënë', 'Martë', 'Mërkurë', 'Enjte', 'Premte', 'Shtunë'],
        monthNames: ['Jan', 'Shk', 'Mar', 'Pri', 'Maj', 'Qer', 'Kor', 'Gus', 'Sht', 'Tet', 'Nën', 'Dhj', 'Janar', 'Shkurt', 'Mars', 'Prill', 'Maj', 'Qershor', 'Korrik', 'Gusht', 'Shtator', 'Tetor', 'Nëntor', 'Dhjetor'],
        AmPm: ['am', 'pm', 'AM', 'PM'],
        S: function (j) {
