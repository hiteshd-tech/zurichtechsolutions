(function ($) {
  ...
  $.extend($.jgrid, {
    ...
    formatter: {
      ...
      date: {
        dayNames: ['Ned', 'Pon', 'Uto', 'Sri', '�et', 'Pet', 'Sub', 'Nedjelja', 'Ponedjeljak', 'Utorak', 'Srijeda', '�etvrtak', 'Petak', 'Subota'],
        monthNames: ['Sij', 'Velj', 'O�u', 'Tra', 'Svi', 'Lip', 'Srp', 'Kol', 'Ruj', 'Lis', 'Stu', 'Pro', 'Sije�anj', 'Velja�a', 'O�ujak', 'Travanj', 'Svibanj', 'Lipanj', 'Srpanj', 'Kolovoz', 'Rujan', 'Listopad', 'Studeni', 'Prosinac'],
        AmPm: ['am', 'pm', 'AM', 'PM'],
        S: function (j) {
          return '';
        },
