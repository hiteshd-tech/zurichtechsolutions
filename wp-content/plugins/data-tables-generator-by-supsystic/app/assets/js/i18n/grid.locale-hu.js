(function ($) {
  ...
  $.extend($.jgrid, {
    ...
    formatter: {
      ...
      date: {
        dayNames: ['Va', 'Hé', 'Ke', 'Sze', 'Csü', 'Pé', 'Szo', 'Vasárnap', 'Hétfő', 'Kedd', 'Szerda', 'Csütörtök', 'Péntek', 'Szombat'],
        monthNames: ['Jan', 'Feb', 'Már', 'Ápr', 'Máj', 'Jún', 'Júl', 'Aug', 'Szep', 'Okt', 'Nov', 'Dec', 'Január', 'Február', 'Március', 'Áprili', 'Május', 'Június', 'Július', 'Augusztus', 'Szeptember', 'Október', 'November', 'December'],
        AmPm: ['de', 'du', 'DE', 'DU'],
        S: function (j) {
          return '.-ik';
        },
