(function ($) {
  ...
  $.extend($.jgrid, {
    ...
    formatter: {
      ...
      date: {
        dayNames: ['Ne', 'Po', 'Ut', 'St', 'Št', 'Pi', 'So', 'Nedela', 'Pondelok', 'Utorok', 'Streda', 'Štvrtok', 'Piatek', 'Sobota'],
        monthNames: ['Jan', 'Feb', 'Mar', 'Apr', 'Máj', 'Jún', 'Júl', 'Aug', 'Sep', 'Okt', 'Nov', 'Dec', 'Január', 'Február', 'Marec', 'Apríl', 'Máj', 'Jún', 'Júl', 'August', 'September', 'Október', 'November', 'December'],
        AmPm: ['do', 'od', 'DO', 'OD'],
        S: function (j) {
