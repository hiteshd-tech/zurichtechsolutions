...
(function ($) {
  var btnCreateObj = {
      ...
      dataList: null,
      initDialog: function () {
        $(this.container).append('<div class="data-tables-select-dialog" hidden>' + '<h1 style="text-align: center;">Select Data Table</h1>' + '<select></select>' + '<button class="button button-primary">Insert</button>' + '</div>');
